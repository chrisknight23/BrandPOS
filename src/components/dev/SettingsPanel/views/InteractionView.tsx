      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        {(currentScreen === 'Cashout' || currentScreen === 'End') && onResetSession && (
            <div className="w-full mb-4">
              <Button
                variant="secondary"
                className="w-full bg-red-500/20 hover:bg-red-500/30 active:bg-red-500/40 border border-red-500/40"
              ...
              >
                <div className="flex items-center justify-center text-white">
                  <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M16 5L21 3L19 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <div className="text-base font-medium">Reset Session (Dev Only)</div>
                </div>
              </Button>
            </div>
          )}
